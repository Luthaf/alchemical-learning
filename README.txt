...
3rd install the specific git commits (current requirements file does NOT work)
    ...
    (get a newer torch rascaline - fixed dotproduct - will change this later)
...
10th When compiling on an HPC cluster (i.e. epfls' jed, check that the latest gcc version (ver. > 11) is loaded
