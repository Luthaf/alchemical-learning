...
def _move_to_torch_by_l(tensor_maps, structure_i):
    ...
    return TensorMap(
        Labels(tensor_map.keys.names, np.asarray(keys, dtype=np.int32)), blocks
            ...
            print(spherical_expansion)
            spherical_expansion = spherical_expansion.keys_to_samples("species_center")
            spherical_expansion = spherical_expansion.keys_to_properties(self._all_neighbor_species_1)
            spherical_expansion = spherical_expansion.keys_to_properties(self._all_neighbor_species_2)
            print(spherical_expansion)
            return _move_to_torch(spherical_expansion, system_i)
